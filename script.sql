...
/*
showcase all of efficiency improves
*/
...
/*
4. show the overall sesion-to-order conversion rate trends for theose same channels. note any periods where we made major improvments or optimization
*/
...
/*
pull monthly trending for revenue and margin by product
*/
...
/*
pull monthly session to the /product page, and show how the % of those sessions clicking through another page has changed over time, along with a view of how conversion from /products to placing an order has improved.
*/
...
SELECT
    ...
    COUNT(DISTINCT wp.website_session_id) / NULLIF(COUNT(DISTINCT pp.website_session_id), 0) AS clickthrough_rt,
    COUNT(DISTINCT o.order_id) AS orders,
    COUNT(DISTINCT o.order_id) / NULLIF(COUNT(DISTINCT pp.website_session_id), 0) AS products_to_order_rt
...
GROUP BY 1, 2
ORDER BY 1, 2;  -- Added ORDER BY for readability (optional)


/*
4th product avalidble as a primary product on December 05, 2014 
pull sales data since then and show how well each product cross-sells form one another
*/
...
recommenddation and opportunities to go forward?
*/